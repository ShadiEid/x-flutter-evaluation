...
import 'customized_animation_widget.dart';
...
class AnimatedColumn extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    animationDuration(Widget e) => Duration(milliseconds: duration + (children.indexOf(e) * animateDelay).toInt());

    return Column(
      mainAxisAlignment: mainAxisAlignment,
      crossAxisAlignment: crossAxisAlignment,
      mainAxisSize: mainAxisSize,
      children: children.map((e) => CustomizedAnimatedWidget(duration: animationDuration(e), child: e)).toList(),
    );
  }
}
